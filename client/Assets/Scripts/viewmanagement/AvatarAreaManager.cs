...
/**
 * The AvatarAreaManager class is the main facade to the whole visual avatar area you scene in your scene.
 * It allows you to create an AvatarView mapped to an ID, and provides information after you clicked on the avatar area in a certain range,
 * around its center.
 * 
 * The AvatarAreaManager creates the avatar views by instantiating an AvatarView prefab, which is a gameobject that wraps both a speechbubble and
 * a skin. See AvatarView for more information.
 * 
 * @author J.C. Wichman
 */
public class AvatarAreaManager : MonoBehaviour
{
    ...
    /**
     * Returns all the current avatar ids we are managing.
