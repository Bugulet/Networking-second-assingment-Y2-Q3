 ...
 *  Say         - passes your text on the SpeechBubble, you can safely 'say' all incoming messages, the SpeechBubble auto queues and displays it.
 * 
 * For instantenous positioning, just set the worldposition directly (probably only needed on spawning).
 * 
 * @author J.C. Wichman
 */
public class AvatarView : MonoBehaviour
{
    ...
    [Tooltip("This value is multiplied with the moveSpeed and stored as the animation speed while walking")]
    public float animatorSpeedMultiplier = 60;

    [Tooltip("This list of skin prefabs this avatar can use. If it has an animator, we also calling IsWalking:bool on it.")]
